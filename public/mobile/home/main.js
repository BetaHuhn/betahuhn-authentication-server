...
async function authenticate(){
    ...
    if (json.status == 400){
        ...
        header.innerHTML = `<h1>Hallo, ${json.name}</h1>`;
        ...
        button3.innerHTML = `<a class="bottom" href="https://betahuhn.de"><button class="btn btn--primary uppercase">URL Kürzen</button></a>`;
    }
    else{
